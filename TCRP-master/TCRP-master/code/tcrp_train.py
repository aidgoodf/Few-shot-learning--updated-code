...
parser.add_argument('--feature_dic', type=str, default='C:/Users/aidan/fall_2021/Independent Study/TCRP-master/TCRP-master/data/Sorafenib/', help='Feature folder')
parser.add_argument('--model_dic', type=str, default='C:/Users/aidan/fall_2021/Independent Study/TCRP-master/TCRP-master/models/', help='Feature folder')
...
parser.add_argument('--tissue_list', type=str, default='C:/Users/aidan/fall_2021/Independent Study/TCRP-master/TCRP-master/data/Sorafenib_tissue_map.pkl', help='Cell line list for different tissues, used for defining meta-tasks in the meta-learning phase')
...
# this sets the drug for the training
drug = args.drug

# sets Value for K
K = args.K

# sets the number of trials, the batch size, and number of updates
...
with open(tissue_list, 'rb') as f:
    # pickle deals with serialization
...
# this is where the algorithm actually starts running trials
for i in range(num_trials):
    
    #sets the meta learner
