...
def get_observed_data_loader(feature, label, tissue_index_list, K, batch_size, tissue_num):
	...
	for batch_feature, batch_label in loader:
		if batch_feature.size()[0] == 1:
			continue
		train_data_list.append( (batch_feature.cpu(), batch_label.cpu()) )
	...
	for batch_feature, batch_label in loader:
		if batch_feature.size()[0] == 1:
			continue
		test_data_list.append( (batch_feature.cpu(), batch_label.cpu()) )
...
#In this function cuda is called which is causing an error
